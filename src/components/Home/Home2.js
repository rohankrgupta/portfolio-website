        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              something, I think… 🤷‍♂️
              <br />
              <br />I am fluent in Web Development stack
              <i>
                <b className="purple"> ReactJS, NodeJS and Databases. </b>
              </i>
              <br />
              <br />
              My am currently exploring &nbsp;
              <i>
                <b className="purple">
                  Machine Learning.
                </b>
              ...
              <br />
              <br />
              I also do a bit of Competitive Programming in my leisure time and 
